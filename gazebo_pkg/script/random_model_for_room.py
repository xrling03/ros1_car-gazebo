...
if __name__ == "__main__":
    ...
    model_configs = [
        ...
        {"name_prefix": "fruit_board_", "path": f"/home/ros/.gazebo/models/{random.choice(fruit_board_folders)}/model.sdf"},
        {"name_prefix": "vage_board_", "path": f"/home/ros/.gazebo//models/{random.choice(vege_board_folders)}/model.sdf"},
        {"name_prefix": "dessert_board_", "path": f"/home/ros/.gazebo//models/{random.choice(dessert_board_folders)}/model.sdf"}
    ]
